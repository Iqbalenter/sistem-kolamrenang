...
class StokAlatController extends Controller
{
    ...
    {
        $jenisAlats = JenisAlat::getActiveJenisAlat();
    ...
    public function store(Request $request)
    {
        ...
        // Cek apakah sudah ada stok untuk jenis alat ini
        $existingStok = StokAlat::where('jenis_alat_id', $request->jenis_alat_id)->first();
        if ($existingStok) {
            return back()->withErrors(['jenis_alat_id' => 'Stok untuk jenis alat ini sudah ada!'])->withInput();
        }
    ...
    public function update(Request $request, StokAlat $stokAlat)
    {
        ...
        // Pastikan jenis_alat_id tidak berubah (untuk keamanan)
        if ($request->jenis_alat_id != $stokAlat->jenis_alat_id) {
            return back()->withErrors(['jenis_alat_id' => 'Jenis alat tidak dapat diubah!'])->withInput();
        }
