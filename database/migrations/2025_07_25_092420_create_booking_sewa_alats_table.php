...
return new class extends Migration
{
    ...
    {
        Schema::create('booking_sewa_alats', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('jenis_alat', ['ban_renang', 'kacamata_renang', 'papan_renang', 'pelampung', 'fins', 'snorkel'])->default('ban_renang');
    ...
    {
        Schema::dropIfExists('booking_sewa_alats');
    }
};
