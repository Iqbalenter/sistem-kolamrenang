...
@section('page-description', 'Edit jenis alat renang')
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-gray-900">Edit Jenis Alat</h1>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('admin.jenis-alat.update', $jenisAlat) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                  placeholder="Deskripsi tentang jenis alat ini...">{{ old('deskripsi', $jenisAlat->deskripsi) }}</textarea>
                    </div>
