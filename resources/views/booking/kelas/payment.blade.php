...
<head>
    ...
    <title>Pembayaran Booking Kelas #{{ $bookingKelas->id }} - Sistem Kolam Renang</title>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-gray-900">Pembayaran Booking Kelas #{{ $bookingKelas->id }}</h1>
                    <a href="{{ route('user.booking.kelas.show', $bookingKelas) }}" class="text-indigo-600 hover:text-indigo-800">
                        ← Kembali ke Detail
                    </a>
                </div>
            </div>
            ...
            @if($bookingKelas->status_pembayaran === 'ditolak')
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-1 text-sm text-red-700">
                                ...
                                @if($bookingKelas->catatan_admin)
                                    <p class="mt-2 font-medium">Catatan Admin: {{ $bookingKelas->catatan_admin }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-lg font-semibold mb-4">Detail Booking Kelas</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <dl class="space-y-2">
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm font-medium">#{{ $bookingKelas->id }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Nama:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->nama_pemesan }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">No. Telepon:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->nomor_telepon }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Email:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->user->email }}</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div>
                                ...
                                <dl class="space-y-2">
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Jenis Kelas:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->jenis_kelas_label }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Instruktur:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->instruktur }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Tanggal:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->tanggal_kelas->format('d M Y') }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Waktu:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->jam_mulai->format('H:i') }} - {{ $bookingKelas->jam_selesai->format('H:i') }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Peserta:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->jumlah_peserta }} orang</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        @if($bookingKelas->catatan)
                            <div class="mt-6 pt-6 border-t">
                                ...
                                <p class="text-gray-700">{{ $bookingKelas->catatan }}</p>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                <dl class="space-y-2">
                                    <div class="flex justify-between">
                                        ...
                                        <dd class="text-sm font-medium">{{ $bookingKelas->metode_pembayaran_label }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Provider:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->provider_pembayaran }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                                        <dt class="text-sm text-gray-500">Nomor Tujuan:</dt>
                                        <dd class="text-sm font-medium">{{ $bookingKelas->nomor_tujuan }}</dd>
                                    </div>
                                    <div class="flex justify-between">
                            ...
                            @if($bookingKelas->bukti_pembayaran)
                                ...
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $bookingKelas->bukti_pembayaran) }}" 
                                        alt="Bukti Pembayaran" 
                                        class="max-w-full h-auto rounded-lg shadow-md mx-auto"
                                        style="max-height: 400px;">
                                    <p class="text-sm text-gray-500 mt-2">
                                        Upload pada: {{ $bookingKelas->updated_at->format('d M Y H:i') }}
                                    </p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <dl class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">Tarif per kelas:</dt>
                                <dd class="text-sm font-medium">Rp {{ number_format($bookingKelas->harga_per_kelas, 0, ',', '.') }}</dd>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="border-t pt-3">
                                <div class="flex justify-between">
                                    ...
                                    <dd class="text-lg font-bold text-indigo-600">Rp {{ number_format($bookingKelas->total_harga, 0, ',', '.') }}</dd>
                                </div>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('user.booking.kelas.show', $bookingKelas) }}" 
            ...
            <div id="payment-form" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
                <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
                    <div class="mt-3">
                        ...
                        <form action="{{ route('user.booking.kelas.select-payment-method', $bookingKelas) }}" method="POST">
                            @csrf
                            <div class="space-y-4">
                                <div>
            ...
            <div id="upload-form" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
                <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
                    <div class="mt-3">
                        ...
                        <form action="{{ route('user.booking.kelas.upload-payment', $bookingKelas) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="space-y-4">
                                <div>
